const LacakPesanan = () => {
  return (
    <div className="w-full max-w-[400px] mx-auto py-4 space-y-6 px-4 font-nunito">
      {/* Status akhir */}
      <div className="mt-2 border rounded-lg px-4 justify-between">
        <div className="p-2 border-gray-400 flex items-center justify-center">
          <svg
            width="400"
            height="30"
            viewBox="0 0 268 25"
      ...
      {/* Timeline Pesanan */}
      <div className="border-2 rounded-[40px] space-y-6 p-4 bg-[rgba(234,251,238,0.44)]">
      {[
          {
