...
const Alamat = ({
  ...
  return (
    <div className="mt-4 px-4">
      <div className="bg-white p-4 rounded-lg shadow-[0px_0px_4px_0px_rgba(0,0,0,0.25)] flex items-start cursor-pointer">
        {/* Icon maps */}
...
const Pesanan = () => {
  return (
    <div className="w-full max-w-[400px] mx-auto py-4 px-4 space-y-6 font-nunito">
      ...
      <div className="flex flex-col items-center space-y-2 px-4">
        <div className="font-nunito text-[24px] font-bold">Terima Kasih</div>
        <div className="font-nunito text-[14px]">Pesanan anda telah berhasil dibuat</div>
      </div>
      <div className='px-4'>
            ...
            <div className="flex flex-col space-y-1.5">
              ...
              <div className="text-[10px] font-nunito flex justify-between items-center">
                <div className="flex items-center space-x-2">
                  ...
                  <span>Standar (Semarang - Gresik)</span>
                </div>
              </div>
      ...
      <div className="px-4 font-nunito text-[14px] font-bold ">Diantar Ke:</div>
