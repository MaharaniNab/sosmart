      ...
      <div className="max-w-[500px]  w-full mx-auto p-4 border-b-2 border-red-400">
        ...
        <main className="-mt-15">
          ...
          <div className="flex justify-between mt-4">
            <button className="flex-1 bg-gray-200 rounded-md py-2 mr-2 flex items-center justify-between px-4">
              <span
            ...
            <button className="flex-1 bg-gray-200 rounded-md py-2 flex items-center justify-between px-4">
              <span
                className="pl-2 text-center"
                style={{
                  color: 'var(--Light-Text-Color, #1B1E28)',
